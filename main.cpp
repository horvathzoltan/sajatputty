...
int main(int argc, char *argv[])
{
    ...
    _globals._serialManager.loadSettings(FileNameHelper::serialSettingsFilePath(),&localEcho);
    _globals._networkManager.loadSettings(FileNameHelper::networkSettingsFilePath());
